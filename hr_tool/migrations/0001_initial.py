# Generated by Django 3.2 on 2023-06-30 05:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MCareerLevel',
            fields=[
                ('id', models.SmallAutoField(primary_key=True, serialize=False, verbose_name='マネジメントレベルid')),
                ('name', models.CharField(max_length=64, verbose_name='マネジメントレベルの名称')),
                ('level', models.SmallIntegerField(verbose_name='マネジメントレベル')),
            ],
        ),
        migrations.CreateModel(
            name='MDte',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='t_training_exp_eid', to=settings.AUTH_USER_MODEL, verbose_name='社員番号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='t_skill_exp_eid', to=settings.AUTH_USER_MODEL, verbose_name='社員番号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='t_precareer_eid', to=settings.AUTH_USER_MODEL, verbose_name='社員番号')),
            ],
        ),
        migrations.CreateModel(
            name='TAssignExp',
            fields=[
                ...
                ('start_date', models.DateField(verbose_name='開始日')),
                ('end_date', models.DateField(verbose_name='終了日')),
                ('eid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='t_assign_exp_eid', to=settings.AUTH_USER_MODEL, verbose_name='社員番号')),
        ...
        migrations.AddField(
            model_name='user',
            name='dte',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user_dte', to='hr_tool.mdte'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='homeoffice',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user_homeoffice', to='hr_tool.mhomeoffice'),
        ),
        migrations.AddField(
            model_name='user',
